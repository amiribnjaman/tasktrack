  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="bg-[#2565e6] px-4 py-2 rounded text-white">
          Create Task
        </button>
      </div>
      ...
      <div className="grid grid-cols-3 mt-4 gap-4">
        ...
        <div className="shadow rounded">
          <div className="text-[15px] font-semibold p-4 relative">
            <span className="text-[10px] text-white absolute top-[-12px] right-[0px] bg-red-300 px-2 py-1 rounded-full">uncomplete</span>
        ...
        {/*-------------- SINGLE CARD ---------------*/}
        <div className="shadow rounded">
          <div className="text-[15px] font-semibold p-4">
            <p className="mb-2 text-[#2565e6]">Web Developement</p>
            <hr />
          </div>
          {/* Body */}
          ...
          {/* BOTTOM */}
          <div className="px-5 py-2 gap-2 flex">
            <button className="text-sm text-white px-4 py-1 bg-blue-300 rounded-full">
              Update
            </button>
            <button className="text-sm px-3 py-1 bg-red-300 rounded-full">
              Delete
            </button>
          </div>
        </div>
        ...
        <div className="shadow rounded">
          ...
          {/* BOTTOM */}
          <div className="px-5 py-2 gap-2 flex">
            <button className="text-sm px-4 py-1 bg-blue-300 rounded-full">
              Update
            </button>
            <button className="text-sm px-3 py-1 bg-red-300 rounded-full">
              Delete
